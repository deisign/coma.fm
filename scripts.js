...
async function getLastFmTrackInfo() {
    const artist = 'Daft Punk'; // Здесь можно указать актуального исполнителя
    const track = 'Get Lucky'; // Здесь можно указать актуальный трек
...
document.addEventListener('DOMContentLoaded', getLastFmTrackInfo);
